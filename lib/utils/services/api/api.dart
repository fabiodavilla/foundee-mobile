...
abstract class Api {
  Future<ResponseType?> getAsync(String route, String params) async {
    final response = convertResponse(await get(
  ...
  Future<ResponseType?> postAsync(String route, IJsonConvertible body) async {
    const storage = FlutterSecureStorage();

    final accessToken = await storage.read(key: 'access_token');

    final response = convertResponse(await post(
  ...
  Future<ResponseType?> simplePostAsync(
